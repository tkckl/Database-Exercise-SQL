...
2. 複製 SQL：
   ...
   - 點擊 "copy" 圖示 (./image/icon-copy.png)
...
8. 您可以使用網站提供的其他功能，例如
   ...
   - 編輯您的 SQL
   - 檢視您先前 SQL 的結果
   (./image/screen-capture-3.png)



# Database Exercise - SQL

This repository contains SQL files for database exercises. All files use standard SQLite-compatible syntax.
...
2. Copy the SQL:
   ...
   - Click the "copy" icon (./image/icon-copy.png)
